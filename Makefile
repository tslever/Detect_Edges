...
INCLUDE_DIRECTORIES = "C:\Users\thoma\Documents\AI\Convolutional_Neural_Network","C:\opencv_4.3.0\build\include","C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.0\include"
...
# My workaround was to add "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.0\lib\x64" to
# Control Panel -> System and Security -> System -> Change Settings -> Advanced ->
# Environmental Variables -> System Variables -> Path -> New.
LIBRARIES_TO_LINK = "C:\opencv_4.3.0\build\x64\vc15\lib\opencv_world430","cudnn"
